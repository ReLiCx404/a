...
exports.API = exports.API_URL = exports.THUMBS_URL = exports.IMAGE_URL = exports.HOST_URL = exports.SortMethods = void 0;
...
var API = /** @class */ (function () {
    ...
    API.prototype.fetchDoujin = function (doujinID) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (+doujinID <= -1)
                return reject(new Error('DoujinID cannot be lower than 1.'));
            node_fetch_1.default(exports.API_URL + "/gallery/" + doujinID)
                ...
                if (data.error) {
                    if (data.error === 'does not exist')
                        ...
                        reject(new nhentaiAPIError(data.error));
                }
                else
                    resolve(new doujin_1.default(data, _this));
            })
                .catch(function (error) { return reject(error); });
        });
    };
    ...
    API.prototype.search = function (query, page, sort) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            node_fetch_1.default(exports.API_URL + "/galleries/search?query=" + query + "&page=" + page + sorting)
                .then(function (data) { return data.json(); })
                .then(function (data) {
                if (data.error)
                    reject(new nhentaiAPIError(data.error));
                else
                    resolve(new search_1.default(data, _this));
            })
                .catch(function (error) { return reject(error); });
        });
    };
    ...
    API.prototype.searchByTagID = function (tagID, page, sort) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var sorting = !!sort ? "&sort=" + sort : '';
            node_fetch_1.default(exports.API_URL + "/galleries/tagged?tag_id=" + tagID + "&page=" + page + sorting)
                .then(function (data) { return data.json(); })
                .then(function (data) {
                if (data.error)
                    reject(new nhentaiAPIError(data.error));
    ...
    API.prototype.searchRelated = function (doujinID, page) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (isNaN(+doujinID))
                return reject(new Error('DoujinID paramater is not a number'));
            node_fetch_1.default(exports.API_URL + "/gallery/" + doujinID + "/related")
                .then(function (data) { return data.json(); })
                .then(function (data) {
                if (data.error)
                    reject(new nhentaiAPIError(data.error));
...
var nhentaiAPIError = /** @class */ (function (_super) {
    ...
    function nhentaiAPIError(response) {
